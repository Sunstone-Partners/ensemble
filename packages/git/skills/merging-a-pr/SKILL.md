---
name: merging-a-pr
description: 'Getting a pull request merged. Use when the user says: "merge the PR", "get this PR green", "land the PR", "fix CI", "the PR is failing", "address review comments".'
version: 1.0.0
phrases:
  - merge the PR
  - get this PR green
