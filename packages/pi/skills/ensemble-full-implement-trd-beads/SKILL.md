...
3. Detect ask_user availability: set INTERACTIVE=true if available, INTERACTIVE=false otherwise (reuses the same detection this file performs again later in Feature Branch Creation).
