---
name: creating-a-trd
description: 'Authoring a technical requirements document. Use when the user says: "create a TRD", "write a TRD", "technical requirements document", "technical design doc", "how should we build this".'
version: 1.0.0
phrases:
  - create a TRD
  - write a TRD
