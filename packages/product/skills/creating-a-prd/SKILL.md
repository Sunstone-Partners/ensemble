---
name: creating-a-prd
description: 'Authoring a product requirements document. Use when the user says: "create a PRD", "write a PRD", "product requirements document", "write product requirements", "draft requirements", "spec out a feature".'
version: 1.0.0
phrases:
  - create a PRD
  - write a PRD
