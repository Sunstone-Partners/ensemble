...
description: Generate real-time productivity metrics and team analytics dashboard (Codex skill for /ensemble:manager-dashboard)
user-invocable: true
---

# Ensemble Command: /ensemble:manager-dashboard

This Codex skill mirrors the Ensemble slash command `/ensemble:manager-dashboard`.
