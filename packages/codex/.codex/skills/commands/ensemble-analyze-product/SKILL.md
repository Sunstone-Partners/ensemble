...
description: Analyze existing brownfield project and generate improvement roadmap (Codex skill for /ensemble:analyze-product)
user-invocable: true
---

# Ensemble Command: /ensemble:analyze-product

This Codex skill mirrors the Ensemble slash command `/ensemble:analyze-product`.
