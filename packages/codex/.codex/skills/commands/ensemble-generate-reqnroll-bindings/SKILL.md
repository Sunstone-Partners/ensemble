...
description: Scaffold a runnable Reqnroll + xUnit test project (features, step stubs, project files) from a PRD (Codex skill for /ensemble:generate-reqnroll-bindings)
user-invocable: true
argument-hint: '[prd-path] [--out <dir>] [--sut <csproj>] [--dry-run] [--force]'
model: gpt-5.1-codex
---

# Ensemble Command: /ensemble:generate-reqnroll-bindings

This Codex skill mirrors the Ensemble slash command `/ensemble:generate-reqnroll-bindings`.
